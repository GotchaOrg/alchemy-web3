...
var web3_core_subscriptions_1 = tslib_1.__importDefault(
...
function createAlchemyWeb3(alchemyUrl, config) {
  ...
  var _a = alchemyContext_1.makeAlchemyContext(alchemyUrl, fullConfig),
  ...
  alchemyWeb3.alchemy = {
      ...
      return callAlchemyJsonRpcMethod({
        ...
        params: [
          tslib_1.__assign(tslib_1.__assign({}, params), {
            ...
            toBlock:
              params.toBlock != null
                ? hex_1.formatBlock(params.toBlock)
                : undefined,
            maxCount:
              params.maxCount != null
                ? web3_utils_1.toHex(params.maxCount)
                : undefined,
          }),
        ],
    ...
    getNftContractMetadata: function (params, callback) {
      return callAlchemyRestEndpoint({
        restSender: restSender,
        callback: callback,
        params: params,
...
function processTokenBalanceResponse(rawResponse) {
  ...
  var fixedTokenBalances = rawResponse.tokenBalances.map(function (balance) {
    return balance.tokenBalance != null
      ? tslib_1.__assign(tslib_1.__assign({}, balance), {
          tokenBalance: web3_eth_abi_1.default.decodeParameter(
            "uint256",
  ...
  return tslib_1.__assign(tslib_1.__assign({}, rawResponse), {
...
function patchSubscriptions(web3) {
  ...
  eth.subscribe = function (type) {
    ...
    return oldSubscribe.apply(
      void 0,
      tslib_1.__spreadArray([type], tslib_1.__read(rest)),
    );
  };
}
/**
