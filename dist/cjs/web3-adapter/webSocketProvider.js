...
var AlchemyWebSocketProvider = /** @class */ (function (_super) {
  ...
  function AlchemyWebSocketProvider(ws, sendJsonRpcPayload, jsonRpcSenders) {
    ...
    _this.handleReopen = function () {
      ...
      var _b = promises_1.makeCancelToken(),
        cancel = _b.cancel,
            ...
            return tslib_1.__generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  ...
                  if (!isCancelled()) {
                    console.error(
                      'Error while backfilling "' +
                        subscription.params[0] +
                        '" subscription. Some events may be missing.',
                      error_1,
                    );
                  }
                  return [3 /*break*/, 3];
      ...
      try {
        for (
          var _c = tslib_1.__values(_this.virtualSubscriptionsById.values()),
            _d = _c.next();
          !_d.done;
          _d = _c.next()
        ) {
    ...
    return tslib_1.__awaiter(this, void 0, void 0, function () {
      ...
      return tslib_1.__generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            subscriptionId =
              (_a = request.params) === null || _a === void 0 ? void 0 : _a[0];
            virtualSubscription =
            ...
            physicalRequest = tslib_1.__assign(tslib_1.__assign({}, request), {
              params: [physicalId],
            });
  ...
  AlchemyWebSocketProvider.prototype.resubscribeAndBackfill = function (
    isCancelled,
    subscription,
  ) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
      ...
      return tslib_1.__generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            (virtualId = subscription.virtualId),
              (method = subscription.method),
              (params = subscription.params),
              (sentEvents = subscription.sentEvents),
              (backfillBuffer = subscription.backfillBuffer),
              (startingBlockNumber = subscription.startingBlockNumber);
          ...
          case 3:
            return [
              4 /*yield*/,
              promises_1.withBackoffRetries(
                function () {
                  return promises_1.withTimeout(
                    _this.backfiller.getNewHeadsBackfill(
                      isCancelled,
                      sentEvents,
                      startingBlockNumber,
                    ),
          ...
          case 4:
            ...
            promises_1.throwIfCancelled(isCancelled);
            events = subscriptionBackfill_1.dedupeNewHeads(
              tslib_1.__spreadArray(
                tslib_1.__spreadArray([], tslib_1.__read(backfillEvents)),
                tslib_1.__read(backfillBuffer),
              ),
            );
          ...
          case 5:
            ...
            return [
              ...
              promises_1.withBackoffRetries(
                function () {
                  return promises_1.withTimeout(
                    _this.backfiller.getLogsBackfill(
                      isCancelled,
                      filter_1,
                      sentEvents,
                      startingBlockNumber,
          ...
          case 6:
            backfillEvents = _b.sent();
            promises_1.throwIfCancelled(isCancelled);
            events = subscriptionBackfill_1.dedupeLogs(
              tslib_1.__spreadArray(
                tslib_1.__spreadArray([], tslib_1.__read(backfillEvents)),
                tslib_1.__read(backfillBuffer),
              ),
  ...
  AlchemyWebSocketProvider.prototype.emitNewHeadsEvent = function (
    virtualId,
    result,
  ) {
    this.emitAndRememberEvent(virtualId, result, getNewHeadsBlockNumber);
  };
  AlchemyWebSocketProvider.prototype.emitLogsEvent = function (
    virtualId,
    result,
  ) {
   ...
   */
  AlchemyWebSocketProvider.prototype.emitAndRememberEvent = function (
    virtualId,
    result,
    getBlockNumber,
  ) {
    ...
    addToPastEventsBuffer(
      ...
      tslib_1.__assign({}, result),
      getBlockNumber,
    );
    this.emitGenericEvent(virtualId, result);
  };
  AlchemyWebSocketProvider.prototype.emitGenericEvent = function (
    virtualId,
    result,
  ) {
    var event = {
