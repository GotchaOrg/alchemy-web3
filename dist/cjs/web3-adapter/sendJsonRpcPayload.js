...
function makeJsonRpcPayloadSender(alchemySendJsonRpc, config) {
  ...
  function setWriteProvider(writeProvider) {
    currentWriteProvider =
      writeProvider !== null && writeProvider !== void 0 ? writeProvider : null;
  }
  return {
...
function getDisallowedMethod(payload) {
  ...
  // disallowed prefix.
  var disallowedRequest =
    payloads.find(function (p) {
      return (
      ...
      switch (_b.label) {
        ...
        case 2:
          ...
          return [
            4 /*yield*/,
            promises_1.delay(
              retryInterval + ((retryJitter * Math.random()) | 0),
            ),
          ];
        case 3:
          _b.sent();
