...
export declare type WebSocketMessage =
  ...
  | SubscriptionEvent;
export declare function isResponse(
  message: WebSocketMessage,
): message is SingleOrBatchResponse;
export declare function isSubscriptionEvent(
  message: WebSocketMessage,
...
export declare type SendJsonRpcFunction = (
  method: string,
  params?: any[],
) => Promise<any>;
...
export declare type JsonRpcSenderMiddleware = (
